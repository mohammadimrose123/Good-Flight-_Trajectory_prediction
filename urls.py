...
from goodflight import settings
...
urlpatterns = [
    ...
    url(r'^Prediction_Of_Flight_Trajectory_Status/$', remoteuser.Prediction_Of_Flight_Trajectory_Status, name="Prediction_Of_Flight_Trajectory_Status"),
    ...
    url(r'^View_Prediction_Of_Flight_Trajectory_Status/$',serviceprovider.View_Prediction_Of_Flight_Trajectory_Status, name="View_Prediction_Of_Flight_Trajectory_Status"),
